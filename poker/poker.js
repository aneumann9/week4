...
$(function() {
  $("#deal").on("click", function(event) {
    ...
    var c1 = window.getDeck()[randomnum(0,51)]
    var c2 = window.getDeck()[randomnum(0,51)]
    var c3 = window.getDeck()[randomnum(0,51)]
    var c4 = window.getDeck()[randomnum(0,51)]
    var c5 = window.getDeck()[randomnum(0,51)]
    var c6 = window.getDeck()[randomnum(0,51)]
  ...
  $("#c6").attr("src", "http://golearntocode.com/images/cards/" + c6 + ".png")
})// Your code goes here!
})
